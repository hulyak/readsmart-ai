// ReadSmart AI - Centralized Configuration (ES6 Module Version)
// This is the ES6 module version for use in service workers
...
const CONFIG = {
  ...
  DEBUG: {
    ...
    // Log initialization and major events
    logInfo: true
  },
...
export const CONTENT_LIMITS = CONFIG.CONTENT_LIMITS;
export const TIMEOUTS = CONFIG.TIMEOUTS;
export const DETECTION = CONFIG.DETECTION;
export const RATE_LIMITS = CONFIG.RATE_LIMITS;
